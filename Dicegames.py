...
print("----WELCOME TO CS-524 PROGRAM 1 Imperative Approach----")
...
if choice == 1:
    ...
    score1 = 0
    score2 = 0      #Initializing score variables here.
    score = 0
    dice1 = 0       #Initializing dice variables here.
    dice2 = 0


    def roll():             #In this function we roll the dice and decide what scores to return for different cases.
        global dice1        # Using global variables for dice
        global dice2
    ...
    def turn():             #In this function we call the roll function and assign score to different players.
        ...
        while 7 > 6:  # Using While statement which always should become true,
            ...
            if player1_chance == "y": # If we press "Y" we give player-1 chance to roll the dice
                                        #  and calculate his score.
                player1 = roll();      # Calling roll function for player-1.
                if dice1 == dice2:
            ...
            if player2_chance == "y": # If we press "Y" we give player-1 chance to roll the dice and calculate his score
                player2 = roll();# Calling roll function for player-2.
                if dice1 == dice2:
                    if dice1 == 3:  # If 3 comes in both the dices we reset player-1 score to 0.
                        score2 = 0
                    else:
    ...
    turn();                     # We call turn function here to execute the Fifty game
    ...
    def roll():     #This function is used to roll the die, and return the player's score
    ...
    def player1_turn():     #This function allows the user to play as player1, and returns player1_score
        ...
        play1 = "y"
        score = roll();     #Here we use roll function to roll the die only for the "first chance".
        ...
        while play1 == "y":     #If the player1 game is going on then it enters the while loop.

            score = roll();         # here we use the roll function again for the rest of the game.
    ...
    def player2_turn():     #This function allows the user to play as player2, and returns player2_score
    ...
    def game():         #This function will call the player1_turn and player2_turn,
                        #  they will be called alternatively so that they get chance one after the other.
        player1 = player1_turn();          # Here we call the player1 function.
        while 7 > 6:                #Here we use while loop which always becomes true,
            ...
            if player2 == "true":  #If player2_turn returns true then it has won then the loop will break.
                ...
                player1 = player1_turn(); #Like this the loop will continue,
                                        #until one of the player wins and the loop breaks.

    game();       #Here we call the game funtion.
